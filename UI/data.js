...
window.MOCK = (function () {
  ...
  const REVIEWS = [
    ...
    { name: '干扰排查助手',       sub: '提交人：李航宇 · 运营值班组', tag: '用户自建',   desc: '面向一线值班员的频段干扰快速定位工具，结合实时频谱与历史案例，平均定位耗时 4.2 分钟。', meta: 'v1.2 · 5 技能 · 1 知识库', c1: '#f43f5e', c2: '#fb7185' },
  ...
  /* ============ AUDIT ============ */
  const AUDIT = [
    { ts: '2026-06-17 14:22:18', user: '李航宇', action: 'EDIT_EMPLOYEE', target: '链路诊断员 / 节点 n3', ip: '10.18.32.41' },
    ...
    { ts: '2026-06-17 13:18:33', user: '李航宇', action: 'CREATE_EMPLOYEE', target: '终端日志分析员',         ip: '10.18.32.41' },
  ...
  const CHAT_MESSAGES = [
    { who: 'bot', t: '14:22:05', text: '你好，李航宇。我是 <b>链路诊断员 · 卫通7号</b>，已为你接入信关站 GW-03 的实时链路指标。可以告诉我你关心的具体问题。' },
