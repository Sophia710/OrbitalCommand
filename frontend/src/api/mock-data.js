...
const EMPLOYEES = [
  /* ============ 超级员工 · S 级（4 个固定类别）============ */
  { id: 'emp_s01', kind: 'super', tier: 1, series: 'terminal',  domain: '终端',     name: '用户终端智能测试官', avatar: '#6366f1', accent: '#a5b4fc', tags: ['终端验证', 'OTA 升级', '标准比对', '回归基线'], description: '面向 CPE、模组、终端芯片的全生命周期智能化测试，统一功能 / 性能 / 一致性 / OTA 四大维度的脚本生成、缺陷回放与回归闭环。', skills: ['终端验证', 'OTA 升级', '标准比对'], publisher: 'AEROS · 旗舰', status: 'published', version: '5.0.0', usage: 28134, createdAt: NOW - 120*DAY },
  { id: 'emp_s02', kind: 'super', tier: 2, series: 'satnet',    domain: '星地链路', name: '星地网络智能测试官', avatar: '#0ea5e9', accent: '#7dd3fc', tags: ['链路诊断', '故障定位', '数据回放', '干扰分析'], description: '覆盖协议一致性、性能基准、故障注入与回放、干扰源定位，端到端输出星地网络健康度评分与处置建议。',         skills: ['链路诊断', '故障定位', '数据回放'], publisher: 'AEROS · 旗舰', status: 'published', version: '5.0.0', usage: 24819, createdAt: NOW - 110*DAY },
  { id: 'emp_s03', kind: 'super', tier: 3, series: 'payload',   domain: '载荷',     name: '卫星载荷智能测试官', avatar: '#14b8a6', accent: '#5eead4', tags: ['遥测解析', '参数调优', '频谱分析', 'EIRP 标定'], description: 'EIRP / G/T 标定、波束跳变、接口验证、异常诊断一体化执行，载荷级高风险操作具备自动审批与回滚能力。',           skills: ['遥测解析', '参数调优', '频谱分析'], publisher: 'AEROS · 旗舰', status: 'published', version: '5.0.0', usage: 19283, createdAt: NOW - 100*DAY },
  { id: 'emp_s04', kind: 'super', tier: 4, series: 'fullchain', domain: '全链路',   name: '全链路智能验收官',   avatar: '#8b5cf6', accent: '#c4b5fd', tags: ['跨域编排', '验收剧本', '根因分析', '运维自动化'], description: '编排跨域测试 / 跨域数据关联 / 根因分析 / 运维剧本自动执行，端到端验收与 7×24 智能运维一体化。',                   skills: ['测控编排', '故障定位', '报告生成'], publisher: 'AEROS · 旗舰', status: 'published', version: '5.0.0', usage: 32410, createdAt: NOW - 130*DAY },

  /* ============ 专业员工 · A 级（场景专家）============ */
  { id: 'emp_001', kind: 'professional', domain: '终端',     name: '终端验证员', avatar: '#8b5cf6', accent: '#d946ef', tags: ['OTA 升级', '终端验证', '标准比对'], description: '面向 CPE、模组、终端芯片的智能化测试，覆盖功能/性能/一致性/OTA 全流程。', skills: ['链路诊断', 'OTA 升级', '终端验证'], publisher: 'AEROS', status: 'published', version: '2.4.1', usage: 12480, createdAt: NOW - 30*DAY },
  { id: 'emp_002', kind: 'professional', domain: '星地链路', name: '链路诊断员',  avatar: '#06b6d4', accent: '#22d3ee', tags: ['链路诊断', '故障定位', '数据回放'], description: '执行协议一致性、性能基准、故障注入与回放，输出网络健康度评分。',       skills: ['链路诊断', '故障定位', '数据回放'], publisher: 'AEROS', status: 'published', version: '3.0.2', usage: 8972,  createdAt: NOW - 25*DAY },
  { id: 'emp_003', kind: 'professional', domain: '载荷',     name: '载荷分析员', avatar: '#10b981', accent: '#a3e635', tags: ['遥测解析', '参数调优', '频谱分析'], description: 'EIRP / G/T、波束跳变、接口验证、异常诊断；高风险操作需人工审批。',           skills: ['遥测解析', '参数调优'], publisher: 'AEROS', status: 'published', version: '1.8.0', usage: 5621,  createdAt: NOW - 20*DAY },
  { id: 'emp_004', kind: 'professional', domain: '全链路',   name: '全链路编排员',     avatar: '#f59e0b', accent: '#fde047', tags: ['测控编排', '故障定位', '报告生成'], description: '编排跨域测试、跨域数据关联、根因分析、运维剧本自动执行。',                       skills: ['测控编排', '故障定位'], publisher: 'AEROS', status: 'published', version: '4.2.0', usage: 15320, createdAt: NOW - 60*DAY },
  { id: 'emp_009', kind: 'professional', domain: '星地链路', name: '干扰分析员',   avatar: '#d946ef', accent: '#f0abfc', tags: ['干扰分析', '频谱分析'],         description: '频谱监测、干扰源定位、信号质量评估，输出干扰处理建议。',                         skills: ['频谱分析', '干扰分析'], publisher: '运控中心',     status: 'rejected', version: '0.3.0', usage: 0,     createdAt: NOW - 1*DAY },
  { id: 'emp_011', kind: 'professional', domain: '终端',     name: '终端管理助理',             avatar: '#fbbf24', accent: '#fde047', tags: ['OTA 升级', '终端验证'],         description: '终端批量管理、灰度发布、配置下发、健康监控。',                                   skills: ['OTA 升级', '终端验证'], publisher: '运控中心', status: 'published', version: '2.0.0', usage: 6210, createdAt: NOW - 12*DAY },
   ...
   * 约束：仅追加，不修改任何已有员工字段；通过 id 唯一识别（isMarketRadar） */
  {
    ...
    description: '7×24 监控商机信号，基于知识库研判，输出可执行的情报建议。',
 ...
 * ============================================================ */
const MY_DRAFTS = [
  { id: 'draft_001', kind: 'professional', domain: '星地链路', name: '链路健康巡检员', avatar: '#06b6d4', accent: '#22d3ee', tags: ['链路诊断', '信关站', '巡检'], description: '面向信关站链路的自动巡检与异常识别,覆盖指标采集、根因定位、处置建议生成。', skills: ['链路诊断', '故障定位', '数据回放'], version: '0.1.0', status: 'draft', createdAt: NOW - 2*HOUR, updatedAt: NOW - 18*MIN, publisher: '当前用户', source: 'mine' },
  { id: 'draft_002', kind: 'professional', domain: '载荷',     name: '遥测智能解析员', avatar: '#10b981', accent: '#a3e635', tags: ['遥测解析', '参数调优'], description: '基于历史遥测大数据的载荷参数自动调优与异常预警。', skills: ['遥测解析', '参数调优', '频谱分析'], version: '0.2.1', status: 'pending', createdAt: NOW - 2*DAY,  updatedAt: NOW - 4*HOUR, publisher: '当前用户', source: 'mine' },
  { id: 'draft_003', kind: 'professional', domain: '终端',     name: '终端灰度发布助理', avatar: '#f59e0b', accent: '#fde047', tags: ['OTA 升级', '终端验证', '灰度'], description: '终端固件灰度发布与回滚,实时健康度监控。', skills: ['OTA 升级', '终端验证'], version: '1.0.0', status: 'published', createdAt: NOW - 7*DAY,  updatedAt: NOW - 1*DAY,  publisher: '当前用户', source: 'mine' },
  { id: 'draft_004', kind: 'professional', domain: '全链路',   name: '跨域根因分析员', avatar: '#8b5cf6', accent: '#c4b5fd', tags: ['根因分析', '故障定位', '跨域'], description: '跨域告警关联与故障树驱动的根因分析。', skills: ['故障定位', '根因分析'], version: '0.3.0', status: 'rejected', createdAt: NOW - 5*DAY,  updatedAt: NOW - 3*DAY, publisher: '当前用户', source: 'mine' },
]
